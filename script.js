...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.research-card, .experience-card, .publication-card, .education-card, .award-card, .contact-item');
...
// Observe counters (if you add them to HTML)
document.addEventListener('DOMContentLoaded', () => {
